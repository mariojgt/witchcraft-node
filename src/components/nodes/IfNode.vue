<template>
    <div class="bg-gray-900/95 backdrop-blur border-[1px] border-blue-500/30 rounded-xl p-4 min-w-[300px] relative text-gray-100">
      ...
      <div class="absolute top-1/2 -right-3 w-3 h-6 bg-gray-800 rounded-r-lg border-r-2 border-y-2 border-green-500/50">
        <Handle type="source" position="right" id="true" class="!bg-green-500" />
      </div>

      <div class="absolute -bottom-3 left-1/2 transform -translate-x-1/2 h-3 w-6 bg-gray-800 rounded-b-lg border-b-2 border-x-2 border-red-500/50">
